        ...
        locationPicker: function() {
            ...
            return this.each(function() {
                ...
                var setPosition = function(latLng, viewport){
                    ...
                    //$(that).val(lat + "," + lng);
                    $("#readings-lat").val(lat);
                    $("#readings-lng").val(lng);
                }
                ...
                options.width = $("#locationMap").css('width');
                //options.height = $(this).parent().css('height');
                ...
                function getCurrentPosition(){
                    var posStr = $(that).val();
                    var latStr = $('#readings-lat').val();
                    var lngStr = $('#readings-lng').val();
                    if(latStr != "" && lngStr != ""){
                            var lat = $.trim(latStr);
                            var lng = $.trim(lngStr);
                ...
                */
                ...
                $(this).bind('forceUpdate',function(event){
                	showPicker();
                });
