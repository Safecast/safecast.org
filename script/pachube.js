...
$(document).ready(function()
{
  $('#map_canvas').visualizeGmCounter(
  {
    pachubeAPI:
    [
            //'feeds/epaStatic.json',
            'feeds/reactors.json',
            'feeds/jrodStatic.json',
            'feeds/rdtn.php',
            'feeds/scrapedStatic.json',
            'feeds/pachubeStatic.json',
            //'feeds/fukushimaStatic.json',
            'feeds/fukushima_full_static.json',
            //'feeds/greenpeaceStatic.json',
            //'feeds/probe002.json',
            'feeds/germanyStatic.json',
            'feeds/spainStatic.json'
