...
$tmpl->set('css', 'style/terms.css');
$tmpl->set('title', 'Safecast Terms');
$tmpl->place('header');
...
<p>
Welcome to Safecast, a web site designed and developed by Uncorked Studios, LLC. The following terms and conditions express how the site and information may be used. Due to the serious nature of the information reported on our site, we would like to call special attention to a few key points.
</p>
<p>
<ol>
<li>We get the data from other companies and individuals. We cannot guarantee the accuracy of the data or the reliability of a source.</li>
<li>The units of measurement for radiation are not commonly understood outside of the scientific community. There are several different ways to express radiation measurements and converting between the types isn't something we feel we ought to be doing, as we may introduce errors or interpretations.</li>
<li>The devices used to gather radiation readings vary in capabilities and quality. Some devices do not measure certain forms of radiation. Devices require calibration for accuracy, and we do not know whether the data reported to us is coming from a properly calibrated source.</li>
</ol>
<p>For these, and other reasons, this site should not be considered a trusted source of radiation reading data. We simply cannot be liable for your usage of this information. Please be safe, and thank you for visiting Safecast.
</p>
...
of the materials
       (information or software) on Uncorked Studios's web
site for personal,
...
on Uncorked Studios's web site;</li>
...
these restrictions and may be terminated by Uncorked Studios at any
...
<ol type="a">
   <li>
       The materials on Uncorked Studios's web site are
provided "as is".
Uncorked Studios makes no warranties, expressed or implied, and hereby
disclaims and negates all other warranties, including without
limitation, implied warranties or conditions of merchantability,
fitness for a particular purpose, or non-infringement of intellectual
property or other violation of rights. Further, Uncorked Studios does
...
<p>
   In no event shall Uncorked Studios or its suppliers be liable for any
damages (including, without limitation, damages for loss of data or
profit, or due to business interruption,) arising out of the use or
inability to use the materials on Uncorked Studios's Internet site,
even if Uncorked Studios or a Uncorked Studios authorized
...
<p>
   The materials appearing on Uncorked Studios's web site could include
technical, typographical, or photographic errors. Uncorked Studios
does not warrant that any of the materials on its web site are
accurate, complete, or current. Uncorked Studios may make changes to
the materials contained on its web site at any time without notice.
Uncorked Studios does not, however, make any commitment to update the
materials.
</p>
...
<p>
   Uncorked Studios has not reviewed all of the sites linked to its
...
Uncorked Studios of the site. Use of any such linked web site is at
the user's own risk.
</p>
...
<p>
   Uncorked Studios may revise these terms of use for its web site at
...
<p>
   Any claim relating to Uncorked Studios's web site shall be governed
by the laws of the State of Oregon without regard to its conflict of
law provisions.
</p>
