...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->get('lang') ?>" lang="<?php echo $this->get('lang') ?>">
	...
	<body>
		<div class="base">
			<div class="header">
				<div class="logo">
					<a href="/"><img src="images/logo.png" alt="Safecast" align="left" /></a><!-- <span class="mainTitle" style="height:60px"><a href="home"><?php echo $this->get('siteName') ?></a> --></span><br/>
				</div>
<!--
				<div class="mainNav">
					...
					<div id="navForumButton" class="mainNavButton"><a href="http://forum.safecast.org" title="<?php echo $this->get('forums') ?>"><?php echo $this->get('forums') ?></a></div>
					<div id="navSubmitButton" class="mainNavButton <?php $pageName=$this->get('pageName'); if($pageName=="submit")echo "navActive"; ?>"><a href="/submit<?php $lang=$this->get('lang'); if($lang=="jp")echo "?lang=jp"; ?>" title="<?php echo $this->get('submitAReading') ?>"><?php echo $this->get('submitAReading') ?></a></div>
				</div>
-->
